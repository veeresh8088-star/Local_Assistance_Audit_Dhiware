...
CRITICAL: A single file may contain both evidence that resolves a control AND missing information that triggers a gap. Evaluate each control independently.
